     ...
     <li className=' relative group'>
        {item.type === "link" ? (
              ...
              <a href="/" classname="px-4 py-2 flex gap-x-1 items-center">
                ...
                <span className='cursor-pointer text-blue-500 absolute transition-all duration-550 font-bold right-0 top-0 group-hover:right-[90%] opacity-0 group-hover:opacity-100'>
                  /
                </span> 
                </>
                ) : (
                  <dic className="flex flex-col items-center">
 ...
 <section>
    <header className="container mx-auto px-5 flex justify-between py-4 items-center">
        ...
        <div className={`${
         ...
         }transition-all duration300 mt-[56px] lg:mt-0 bg-dark-hard lg:bg-transparent z-[49] flex flex-col w-full lg:w-auto justify-center lg:justify-end  lg:flex-row fixed top-0 bottom-0  lg:static gap-x-9`}>
            <ul className="text-white items-center gap-y-5 lg:text-dark-soft flex flex-col lg:flex-row gap-x-2 font-simibold ">
